...
<body>
	...
	<div class="container">
		...
		<div class="container" id="pie" name="pie">
		<footer>
                        <p>&copy; Un Techo para mi pais - Costa Rica 2013</p>
                </footer>
	</div>
...
<!-- Le javascript
        ...
        <script src="/src/js/bootstrap-tab.js"></script>
        <script src="/src/js/bootstrap-tooltip.js"></script>
        <script src="/src/js/bootstrap-popover.js"></script>
